...
from belief_model import get_hand_probas
...
def create_obs_stacker(environment, belief_level, history_size=4):
  ...
  if belief_level == -1:
    ...
    shape = environment.vectorized_observation_shape()[0] + 125
...
def parse_observations(observations, num_actions, obs_stacker, belief_level):
